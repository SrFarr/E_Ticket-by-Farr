...
fun UserKeretaUi(
    ...
    // Filter hanya kereta
    val keretaList = transportasiVm.transportasiList.collectAsState().value.filter { it.jenis == "Kereta" }
    ...
    Card(
        ...
        Column(
            ...
            Row(
                ...
                Column {
                    Text("📍 Rute", style = MaterialTheme.typography.bodySmall, color = Color(0xFF388E3C))
                    Text("${kereta.asal} → ${kereta.tujuan}",
                        fontWeight = FontWeight.Medium)
                }

                Column {
                    Text("⏰ Berangkat", style = MaterialTheme.typography.bodySmall, color = Color(0xFF388E3C))
                    Text(formatDate(kereta.waktuBerangkat),
                        fontWeight = FontWeight.Medium)
                }
            }
        }
