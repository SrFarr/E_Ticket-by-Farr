...
fun UserDetailPesawatUi(
    ...
    val totalHarga = pesawat.harga * jumlah
                ...
                Card(
                    ...
                    Column(
                        ...
                        Row(
                            ...
                            Column {
                                Text("✈️ Jenis", style = MaterialTheme.typography.bodySmall, color = Color(0xFF1E88E5))
                                Text(pesawat.jenis, fontWeight = FontWeight.Medium)
                            }
                            Column {
                                Text("💰 Harga", style = MaterialTheme.typography.bodySmall, color = Color(0xFF1E88E5))
                                Text(formatCurrency(pesawat.harga), fontWeight = FontWeight.Bold)
                            }
                        }
                        ...
                        Row(
                            ...
                            Column {
                                Text("📍 Dari", style = MaterialTheme.typography.bodySmall, color = Color(0xFF1E88E5))
                                Text(pesawat.asal, fontWeight = FontWeight.Medium)
                            }
                            Column {
                                Text("🎯 Ke", style = MaterialTheme.typography.bodySmall, color = Color(0xFF1E88E5))
                                Text(pesawat.tujuan, fontWeight = FontWeight.Medium)
                            }
                        }

                        Spacer(modifier = Modifier.height(12.dp))

                        Text("⏰ Waktu Berangkat", style = MaterialTheme.typography.bodySmall, color = Color(0xFF1E88E5))
                        Text(formatDate(pesawat.waktuBerangkat), fontWeight = FontWeight.Medium)
                    }
                }
                ...
                Card(
                    ...
                    Column(
                        ...
                        Button(
                            ...
                            Text("Booking Sekarang", fontSize = 16.sp)
                        }
                    }
                }
            }
